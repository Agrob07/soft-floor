  ...
  return (
    <div className="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
            <div className="xl:w-2/6 lg:w-2/5 w-80 md:block hidden">
                <img className="w-full " alt="img of a girl posing" src="https://cdn.27.ua/sc--media--prod/default/50/9b/02/509b02fb-245d-4ebe-a665-de3781653f7b.jpg" />
                <img className="mt-6 w-full" alt="img of a girl posing" src="https://cdn.27.ua/sc--media--prod/default/07/84/71/0784718e-48bb-4d82-b13d-c5be89b221c3.jpeg" />
            </div>
            <div className="md:hidden  p-5 gap-2" >
                <img className="w-full  mb-3" alt="img of a girl posing" src="https://cdn.27.ua/sc--media--prod/default/50/9b/02/509b02fb-245d-4ebe-a665-de3781653f7b.jpg" />
               
                <img className="w-full" alt="img of a girl posing" src="https://cdn.27.ua/sc--media--prod/default/07/84/71/0784718e-48bb-4d82-b13d-c5be89b221c3.jpeg" />
          
            </div>
            <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
                <div className="border-b border-gray-200 pb-6">
                    <p className="text-sm leading-none text-gray-600">Ռետինե սալիկ</p>
                    <h1
                        className="
							lg:text-2xl
							text-xl
                ...
                <div className="py-4 border-b border-gray-200 flex items-center justify-between">
                    <p className="text-base leading-4 text-gray-800">Գույն</p>
                    <div className="flex items-center justify-center">
                        <p className="text-sm leading-none text-gray-600"> կանաչ</p>
                        <div
                            className="
								w-6
								h-6
                ...
                <div className="py-4 border-b border-gray-200 flex items-center justify-between">
                    <p className="text-base leading-4 text-gray-800">Չափ</p>
                    <div className="flex items-center justify-center">
                        <p className="text-sm leading-none text-gray-600 mr-3">4 սմ</p>

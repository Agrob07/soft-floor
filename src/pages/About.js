...
const About = () => {
    return (
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-2 md:px-6 py-9 px-4">
           
            <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
                <div className="w-full lg:w-6/12">
                    <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">Մենք այստեղ ենք ձեր դիզայնը հասանելի և հաճելի դարձնելու համար</h2>
                ...
                <div className="w-full lg:w-6/12">
                    <img className="lg:block hidden w-full" src="/assets/eraz.jpg" alt="people discussing on board" />
            ...
            <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
                <div>
                    <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">Հիմնադրվել է</p>
            ...
            <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
                <div className="w-full lg:w-6/12">
                    <h2 className="font-bold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800">Մեր առաքելությունը</h2>
